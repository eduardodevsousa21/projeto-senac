# Gestão de invetário (Sola-pé)

Projeto proposto pela instituição SENAC, feito em cSharp que demonstram diversas funcionalidades, em suma maioria voltadas para o estoque, focando em quatro setores (RH, TI, Logística e Produção).
